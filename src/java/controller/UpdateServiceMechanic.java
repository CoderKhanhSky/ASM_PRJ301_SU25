 ...
 * @author Admin_Coder
 */
public class UpdateServiceMechanic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateServiceMechanic</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateServiceMechanic at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ServiceMechanic sm = dao.getServiceMechanicByID(serviceTicketID, serviceID);
            request.setAttribute("serviceSM", sm);
            request.getRequestDispatcher("UpdateSM.jsp").forward(request, response);
        } catch (Exception e) {
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ServiceMechanicDAO dao = new ServiceMechanicDAO();
            dao.updateServiceMechanic(new ServiceMechanic(serviceTicketID, serviceID, mechanicID, hours, comment, rate));
            response.sendRedirect("ListServiceMechanic");
        } catch (Exception e) {
        }
    }
